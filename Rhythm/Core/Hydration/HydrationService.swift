...
final class HydrationService {
  ...
  func history(from rawStart: String? = nil, to rawEnd: String? = nil) async throws
    -> [HydrationEntry]
  {
  ...
  private func parsedEntries(from state: HydrationState) throws -> [(
    entry: HydrationEntry, date: Date
  )] {
